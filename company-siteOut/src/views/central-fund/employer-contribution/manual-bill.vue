      ...
      <el-table :data="noticeList" style="width: 100%">
        ...
        <el-table-column label="操作" width="320" fixed="right">
          <template #default="scope">
            ...
            <!-- 提交中状态的按钮 -->
            <template v-if="scope.row.status === '提交中'">
              <el-button 
                type="primary" 
                size="small"
...
export default {
      ...
      noticeList: [
        {
          ...
          period: '2025年3月',
          amount: '128,500.00',
          generateTime: '2025-03-01 09:30:00',
          status: '待確認'
        },
        {
          id: 2,
          ...
          period: '2025年2月',
          amount: '95,280.00',
          generateTime: '2025-02-01 11:15:00',
          status: '待確認'
        },
        {
          id: 3,
          planNo: 'ER11111',
          planName: 'ER11111 子公司A央積金計劃',
          period: '2025年1月',
          amount: '236,750.00',
          generateTime: '2025-01-01 14:20:00',
          status: '提交中'
        }
      ]
    }
  ...
  methods: {
    ...
    viewDetail(notice) {
      ...
      this.$router.push({
        path: `/central-fund/employer-contribution/manual-bill-detail/${notice.planNo}`,
        query: { 
    ...
    resubmitList(notice) {
      this.$confirm(
        ...
        // 设置状态为提交中
        notice.status = '提交中'
        this.$message.success('已設置為提交中狀態，正在跳轉到清單提交頁面...')
