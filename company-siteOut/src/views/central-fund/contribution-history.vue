      ...
      <el-form :model="queryForm" :inline="true" class="query-form">
        <el-form-item label="計劃名稱">
          <el-select v-model="queryForm.planName" placeholder="請選擇計劃" clearable style="width: 180px">
            ...
            <el-option label="央積金計劃C" value="plan-c" />
          </el-select>
        </el-form-item>
...
const historyList = ref([
  {
    ...
    remark: '正常月度供款，所有雇员信息已核实',
    employeeDetails: [
      { employeeName: '张三', employeeNo: 'EMP001', employerContribution: '3,500.00', employeeContribution: '3,500.00', totalContribution: '7,000.00', status: '已对账' },
      { employeeName: '李四', employeeNo: 'EMP002', employerContribution: '4,000.00', employeeContribution: '4,000.00', totalContribution: '8,000.00', status: '已对账' },
      { employeeName: '王五', employeeNo: 'EMP003', employerContribution: '3,200.00', employeeContribution: '3,200.00', totalContribution: '6,400.00', status: '已对账' }
    ],
    operationLogs: [
      { id: 1, timestamp: '2024-01-20 14:30:00', operation: '创建供款记录', operator: '陈大文', type: 'primary' },
      { id: 2, timestamp: '2024-01-22 10:15:00', operation: '上传供款凭证', operator: '陈大文', type: 'success' },
      { id: 3, timestamp: '2024-01-25 16:45:00', operation: '对账完成', operator: '系统自动', type: 'success' }
    ]
  },
  {
    id: 2,
    ...
    remark: '年末供款，包含年终奖励供款',
    employeeDetails: [
      { employeeName: '张三', employeeNo: 'EMP001', employerContribution: '3,500.00', employeeContribution: '3,500.00', totalContribution: '7,000.00', status: '已对账' },
      { employeeName: '李四', employeeNo: 'EMP002', employerContribution: '4,000.00', employeeContribution: '4,000.00', totalContribution: '8,000.00', status: '已对账' }
    ],
    operationLogs: [
      { id: 1, timestamp: '2023-12-20 14:30:00', operation: '创建供款记录', operator: '陈大文', type: 'primary' },
      { id: 2, timestamp: '2023-12-22 10:15:00', operation: '上传供款凭证', operator: '陈大文', type: 'success' },
      { id: 3, timestamp: '2023-12-25 16:45:00', operation: '对账完成', operator: '系统自动', type: 'success' }
    ]
  },
  {
    id: 3,
    ...
    employerAmount: '90,000.00',
    employeeAmount: '90,000.00',
    totalAmount: '180,000.00',
    employeeCount: 25,
    paymentDate: '2023-11-25',
    status: '已完成',
    recordNo: 'CH2023110002',
    voucherNo: 'VC2023110002',
    processor: '李小明',
    submitTime: '2023-11-20 09:30:00',
    completeTime: '2023-11-25 14:20:00',
    remark: '手动供款，部分雇员信息更新',
    employeeDetails: [
      { employeeName: '赵六', employeeNo: 'EMP004', employerContribution: '3,000.00', employeeContribution: '3,000.00', totalContribution: '6,000.00', status: '已对账' },
      { employeeName: '孙七', employeeNo: 'EMP005', employerContribution: '3,500.00', employeeContribution: '3,500.00', totalContribution: '7,000.00', status: '已对账' }
    ],
    operationLogs: [
      { id: 1, timestamp: '2023-11-20 09:30:00', operation: '创建手动供款记录', operator: '李小明', type: 'primary' },
      { id: 2, timestamp: '2023-11-22 11:20:00', operation: '审核通过', operator: '陈大文', type: 'success' },
      { id: 3, timestamp: '2023-11-25 14:20:00', operation: '对账完成', operator: '系统自动', type: 'success' }
    ]
  }
])
...
const exportHistory = () => {
  ElMessage.success('開始導出歷史數據，請稍候...')
  // 實際項目中這裡會調用導出API
}
...
const downloadVoucher = (record) => {
  ElMessage.success(`開始下載${record.period}的供款憑證`)
  // 實際項目中這裡會調用下載API
}

const downloadNotice = (record) => {
  ElMessage.success(`開始下載${record.period}的央積金供款通知書`)
  // 實際項目中這裡會調用下載API
}
