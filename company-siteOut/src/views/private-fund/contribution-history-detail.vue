        ...
        <div class="card-header">
          <div>
            ...
            <span style="margin-left: 12px; font-weight: bold;">
              私退金供款歷史詳情 - {{ recordDetail?.recordNo }}
            </span>
          </div>
      ...
      <div v-if="recordDetail">
        <div class="detail-section">
              ...
              <el-descriptions :column="2" border size="large">
                ...
                <el-descriptions-item label="記錄編號" label-class-name="desc-label">
                  {{ recordDetail.recordNo }}
                </el-descriptions-item>
                <el-descriptions-item label="憑證編號" label-class-name="desc-label">
                  {{ recordDetail.voucherNo || '無' }}
                </el-descriptions-item>
              ...
              <div class="section-header" style="margin-top: 40px;">
                ...
                <div class="summary-info">
                  <span>共 {{ recordDetail.employeeDetails?.length || 0 }} 名僱員，當前顯示 {{ paginatedEmployeeDetails.length }} 條</span>
                </div>
              </div>
              ...
              <el-table :data="paginatedEmployeeDetails" border>
                ...
                <el-table-column prop="subscriptionDate" label="基金認購日" min-width="120">
                ...
                <el-table-column prop="totalContribution" label="個人總供款" min-width="140" align="right">
                  <template #default="scope">
...
const mockData = {
  1: {
    ...
    remark: '正常月度私退金供款，投资组合按计划配置。本月市场表现良好，预期收益稳定。已完成投资风险评估，投资策略符合员工风险偏好。',
    currentBalance: '168,000.00',
    expectedReturn: '5.8%',
    retirementYear: '2045',
    projectedAmount: '920,000.00',
    employeeDetails: [
      { employeeName: '张三', employeeNo: 'EMP001', subscriptionDate: '2024-01-22', relevantIncome: '32,000.00', employmentStatus: '在职', employerContribution: '3,200.00', employeeContribution: '3,200.00', totalContribution: '6,400.00', status: '已对账' },
      { employeeName: '李四', employeeNo: 'EMP002', subscriptionDate: '2024-01-22', relevantIncome: '38,000.00', employmentStatus: '在职', employerContribution: '3,800.00', employeeContribution: '3,800.00', totalContribution: '7,600.00', status: '已对账' },
      { employeeName: '王五', employeeNo: 'EMP003', subscriptionDate: '2024-01-22', relevantIncome: '30,000.00', employmentStatus: '在职', employerContribution: '3,000.00', employeeContribution: '3,000.00', totalContribution: '6,000.00', status: '已对账' },
      { employeeName: '赵六', employeeNo: 'EMP004', subscriptionDate: '2024-01-22', relevantIncome: '36,000.00', employmentStatus: '在职', employerContribution: '3,600.00', employeeContribution: '3,600.00', totalContribution: '7,200.00', status: '已对账' },
      { employeeName: '孙七', employeeNo: 'EMP005', subscriptionDate: '2024-01-22', relevantIncome: '34,000.00', employmentStatus: '在职', employerContribution: '3,400.00', employeeContribution: '3,400.00', totalContribution: '6,800.00', status: '已对账' },
      { employeeName: '周八', employeeNo: 'EMP006', subscriptionDate: '2024-01-22', relevantIncome: '31,000.00', employmentStatus: '在职', employerContribution: '3,100.00', employeeContribution: '3,100.00', totalContribution: '6,200.00', status: '已对账' },
      { employeeName: '吴九', employeeNo: 'EMP007', subscriptionDate: '2024-01-22', relevantIncome: '37,000.00', employmentStatus: '在职', employerContribution: '3,700.00', employeeContribution: '3,700.00', totalContribution: '7,400.00', status: '已对账' },
      { employeeName: '郑十', employeeNo: 'EMP008', subscriptionDate: '2024-01-22', relevantIncome: '33,000.00', employmentStatus: '在职', employerContribution: '3,300.00', employeeContribution: '3,300.00', totalContribution: '6,600.00', status: '已对账' },
      { employeeName: '刘十一', employeeNo: 'EMP009', subscriptionDate: '2024-01-22', relevantIncome: '35,000.00', employmentStatus: '在职', employerContribution: '3,500.00', employeeContribution: '3,500.00', totalContribution: '7,000.00', status: '已对账' },
      { employeeName: '陈十二', employeeNo: 'EMP010', subscriptionDate: '2024-01-22', relevantIncome: '39,000.00', employmentStatus: '在职', employerContribution: '3,900.00', employeeContribution: '3,900.00', totalContribution: '7,800.00', status: '已对账' },
      { employeeName: '杨十三', employeeNo: 'EMP011', subscriptionDate: '2024-01-22', relevantIncome: '28,000.00', employmentStatus: '离职', employerContribution: '2,800.00', employeeContribution: '2,800.00', totalContribution: '5,600.00', status: '已对账' },
      { employeeName: '黄十四', employeeNo: 'EMP012', subscriptionDate: '2024-01-22', relevantIncome: '40,000.00', employmentStatus: '在职', employerContribution: '4,000.00', employeeContribution: '4,000.00', totalContribution: '8,000.00', status: '已对账' }
    ]
  },
  2: {
    id: 2,
    ...
    remark: '年末私退金供款，包含年终奖励供款和投资调整。根据年度市场表现，对投资组合进行重新平衡，确保风险收益比例合理。',
    currentBalance: '155,000.00',
    expectedReturn: '5.5%',
    retirementYear: '2045',
    projectedAmount: '890,000.00',
    employeeDetails: [
      { employeeName: '张三', employeeNo: 'EMP001', subscriptionDate: '2023-12-22', relevantIncome: '32,000.00', employmentStatus: '在职', employerContribution: '3,200.00', employeeContribution: '3,200.00', totalContribution: '6,400.00', status: '已对账' },
      { employeeName: '李四', employeeNo: 'EMP002', subscriptionDate: '2023-12-22', relevantIncome: '38,000.00', employmentStatus: '在职', employerContribution: '3,800.00', employeeContribution: '3,800.00', totalContribution: '7,600.00', status: '已对账' }
    ]
  }
}
...
const downloadVoucher = () => {
  ElMessage.success(`开始下载${recordDetail.value.period}的私退金供款凭证`)
}
...
.projection-item .value.highlight {
  color: #2C8976;
  font-size: 16px;
}
