        ...
        <div class="card-header">
          <div>
            ...
            <span style="margin-left: 12px; font-weight: bold;">
              私退金供款記錄詳情 - {{ recordDetail?.planName }}
            </span>
          </div>
            ...
            <el-col :span="6">
              <div class="statistic-item vested-contribution">
                ...
                <div class="statistic-content">
                  ...
                  <div class="statistic-desc">稅務抵扣金額</div>
                </div>
              </div>
            </el-col>
...
const mockRecordDetail = {
  ...
  processedBy: '陈经理',
  remarks: '私退金正常月度自动供款，雇主供款比例较高',
  recordNumber: 'PF-2024010001',
  employerTotal: 123000.00, // 私退金雇主供款比例更高
  employeeTotal: 62000.00,
  deductionTotal: 12300.00
}
...
const mockEmployeeDetails = [
  {
    ...
    employerRate: '10%', // 私退金雇主比例通常更高
    employerAmount: 2500.00,
    employeeRate: '5%',
  ...
  },
  {
    ...
    employerRate: '10%',
    employerAmount: 2200.00,
    employeeRate: '5%',
    employeeAmount: 1100.00,
    deductionAmount: 220.00,
    totalAmount: 3300.00,
    status: 'success'
  },
  {
    ...
    employerRate: '12%', // 部分员工可能有不同比例
    employerAmount: 2400.00,
    employeeRate: '6%',
    employeeAmount: 1200.00,
    deductionAmount: 240.00,
    totalAmount: 3600.00,
    status: 'success'
  },
  {
    ...
    employerRate: '10%',
    employerAmount: 1800.00,
    employeeRate: '5%',
    employeeAmount: 900.00,
    deductionAmount: 180.00,
    totalAmount: 2700.00,
    status: 'pending'
  },
  {
    ...
    employerRate: '10%',
    employerAmount: 1600.00,
    employeeRate: '5%',
    employeeAmount: 800.00,
    deductionAmount: 160.00,
    totalAmount: 2400.00,
    status: 'success'
  }
]
...
const getRecordDetail = async () => {
  try {
    ...
    console.log('私退金记录详情加载完成:', recordDetail.value)
  } catch (error) {
...
const handleDownloadVoucher = () => {
  ElMessage.success('正在生成私退金供款凭证，请稍候...')
  // TODO: 实现下载凭证功能
}

// 打印详情
const handlePrint = () => {
  ElMessage.success('正在生成私退金供款通知书，请稍候...')
  // TODO: 实现下载供款通知书功能
}

// 导出明细
const handleExportDetail = () => {
  ElMessage.success('正在导出私退金员工供款明细，请稍候...')
  // TODO: 实现导出明细功能
}
